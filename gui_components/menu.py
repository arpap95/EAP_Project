...
from gui_components.add_cust import addNewClient
from gui_components.delete_cust import deleteCustomer
from gui_components.appointment_manager import appointment_management
from gui_components.customer_manager import customer_management
